...
describe('Other Management CRUD', () => {
    //Governing Documentation; SoA edit; Business Process Add
})

describe('Configuration Catalogues + Security Posture', () => {
    //Asset Class; Owner; Regulation; Requirements; Impacts; Security Posture
})
